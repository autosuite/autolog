 ...
 */
export declare function findLatestSemVerUsingString(tags: string, stableOnly: boolean): Promise<SemVer>;
/**
 ...
 */
export declare function compareSemVer(largestSeen: SemVer, current: SemVer): Promise<SemVer>;
/**
